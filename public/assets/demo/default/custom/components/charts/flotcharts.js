var FlotchartsDemo = function () {
    var t = function () {
            ...
            for (var o = [], e = 0; e < 2 * Math.PI; e += .25) o.push([e, Math.cos(e)]);
            for (var i = [], e = 0; e < 2 * Math.PI; e += .1) i.push([e, Math.tan(e)]);
            $.plot($("#m_flotcharts_1"), [{
                label: "sin(x)",
                data: t,
                lines: {
        ...
        o = function () {
            ...
            for (var e = [], o = [], i = 0; i < 14; i += .1) e.push([i, Math.sin(i)]), o.push([i, Math.cos(i)]);
        ...
        a = function () {
            function t() {
                for (o.length > 0 && (o = o.slice(1)); o.length < i;) {
                    ...
                    t < 0 && (t = 0), t > 100 && (t = 100), o.push(t)
                }
                for (var e = [], a = 0; a < o.length; ++a) e.push([a, o[a]]);
                return e
            }

            function e() {
                r.setData([t()]), r.draw(), setTimeout(e, a)
            }
            var o = [],
                i = 250,
                a = 30,
        ...
        r = function () {
            ...
            for (var e = [], o = 0; o <= 10; o += 1) e.push([o, parseInt(30 * Math.random())]);
            for (var i = [], o = 0; o <= 10; o += 1) i.push([o, parseInt(30 * Math.random())]);
            for (var a = [], o = 0; o <= 10; o += 1) a.push([o, parseInt(30 * Math.random())]);
            var r = 0,
                l = !0,
                n = !1,
                s = !1;
            $(".stackControls input").click(function (e) {
                e.preventDefault(), r = "With stacking" == $(this).val() || null, t()
            }), $(".graphControls input").click(function (e) {
                e.preventDefault(), l = -1 != $(this).val().indexOf("Bars"), n = -1 != $(this).val().indexOf("Lines"), s = -1 != $(this).val().indexOf("steps"), t()
            }), t()
        },
        l = function () {
            var t = function (t) {
