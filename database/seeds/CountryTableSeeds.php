...
class CountryTableSeeds extends Seeder
{
    ...
    public function run()
    {
    	...
    	Country::create( [
    		'id'=>39,
    		'name_ar'=>'ساحل العاج (ساحل العاج)',
    		'name_fr'=>'Cote D\'Ivoire (Côte d\'Ivoire)',
    	...
    	Country::create( [
    		...
    		'name_fr'=>'Iles Malouines (Malouines)',
    	...
    	Country::create( [
    		'id'=>71,
    		'name_ar'=>'بريطانيا العظمى (المملكة المتحدة)',
    		'name_fr'=>'Grande-Bretagne (UK)',
    		'name_en'=>'Great Britain (UK)',
    		'code'=>'gb'
    	] );
    	...
    	Country::create( [
    		'id'=>84,
    		'name_ar'=>'جورجيا وجزر ساندويتش',
    		'name_fr'=>'Géorgie du Sud et les îles Sandwich du Sud',
    		'name_en'=>'S. Georgia and S. Sandwich Islands',
    		'code'=>'gs'
    	] );
    	...
    	Country::create( [
    		'id'=>158,
    		'name_ar'=>'نيوزيلندا (اوتياروا)',
    		'name_fr'=>'Nouvelle-Zélande (Aotearoa)',
    		'name_en'=>'New Zealand (Aotearoa)',
    		'code'=>'nz'
    	] );
    	...
    	Country::create( [
    		...
    		'name_fr'=>'Territoire Palestinien',
    	...
    	Country::create( [
    		'id'=>228,
    		'name_ar'=>'زائير (سابقة)',
    		'name_fr'=>'Zaïre (ancien)',
    		'name_en'=>'Zaire (former)',
    		'code'=>'zr'
    	] );
