...
{{$saved_questions->count()}} {{ trans('profile.Saved_Questions') }}
<hr>
<ul class="nav nav-tabs" id="myTab" role="tablist">
 <li class="nav-item">
  <a class="nav-link {{ request()->order == 'recnet' ? 'active' : '' }}" id="profile-tab"  href="{{ url('profile/'.$user->id.'/saved/?order=recnet') }}" role="tab" aria-controls="profile" aria-selected="false">{{ trans('profile.Most_Recent') }}</a>
</li>
<li class="nav-item">
  <a class="nav-link {{ request()->order == 'votes' ? 'active' : '' }}" id="profile-tab"  href="{{ url('profile/'.$user->id.'/saved/?order=votes') }}" role="tab" aria-controls="profile" aria-selected="false">{{ trans('profile.Top_Voted') }}</a>
</li>
</ul> 
...
@endforeach
{{ $saved_questions->appends(Request::input())->links() }}
